...
-- Reinicia la base de datos completa para aplicar la nueva estructura (columna imagen)
DROP DATABASE IF EXISTS inventario_muebles_db;
CREATE DATABASE inventario_muebles_db;

USE inventario_muebles_db;
